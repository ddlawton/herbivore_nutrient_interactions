...
taken from fertilized treatment cages. Colors represent treatment.
Smaller lines represent raw individual locust intake targets with large
lines and points representing estimated marginal means. Individual time
step targets can be seen in
Supplementary Figure~\ref{suppfig-field-cage-rebalancing-facet}.}
...
\includegraphics{output/publication_figures/spatial_modeling_locust_outbreak_with_soil_NTO_PTO.png}
...
(outbreak) observations, nil observations (0), and the total
observations. Grid not at a 1 km\textsuperscript{2} scale in this figure
for demonstration purposes as the cells would be too small to see.}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{output/publication_figures/spatial_modeling_outbreak_all_model_variables.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{output/publication_figures/spatial_modeling_nil_all_model_variables.png}
...
\includegraphics{output/publication_figures/spatial_modeling_locust_outbreak_with_map.png}
...
Treatment, C = carbon, N = Nitrogen, Prot = protein, Carb =
Carbohydrates.}
