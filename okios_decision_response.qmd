...
*Thank you for this suggestion. We have integrated studies **X,Y,Z** studies that help bridge the gap between concepts. Please see lines **XXX***
...
*We have added a discussion on ecological stoichiometry in the introduction and discussion sections. Please see **LINES XXX***
...
*Since we aggregated locust outbreaks to spatial grids (supplementary figure 2), the effects of annual precipitation are glossed over and the effects of more static variables are more pronounced. This is because instead of predicting the specific locust plague outbreak, we are predicting the number of outbreaks likely to occur in a 1x1 km\^2 grid. As such, the relationship between outbreaks summed up to the grid and mean annual precipitation is weak and very different from the more static environmental variable models (Supplementary Figure 8 and Figure 5). Given that this relationship is different and that the relationship between soil nitrogen and annual precipitation is not 1:1 (Supplementary Figure 5C), we are likely seeing the effect of soil nitrogen on the likelihood of Chortocietes terminifera outbreaks.*
...
*We have clarified this section to say: 'Consumption in the two diet pairings did not differ, indicating that instead of consuming between the diets randomly (which would be expected if nutrients had no impact on diet consumption) locusts were actively balancing their protein and carbohydrate consumption (@suppfig-field-pop-nutrients A, @tbl-field-population-it-model).'*
...
*Arianne: have any opinions here?*
...
*Yes, data was extracted only for 1km x 1km grid cells that contained at least one locust survey record. So for example, since Western Australia has no observations, there was no soil data used from this region.s*